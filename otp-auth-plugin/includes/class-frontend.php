            ...
            <div class="otp-auth-form-container">
                ...
                <form id="otp-auth-form" class="otp-auth-form" onsubmit="return false;">
                    ...
                    <div id="step-email" class="otp-auth-step">
                        ...
                        <?php if (!empty($settings['google_login_enabled'])): ?>
                        <button type="button" id="google-login-btn" class="otp-auth-btn otp-auth-btn-google">
                            ...
                            <span class="btn-text"><?php _e('Continue with Google', 'otp-auth-plugin'); ?></span>
                        ...
                        <div class="otp-auth-divider">
                            <span><?php _e('or continue with email', 'otp-auth-plugin'); ?></span>
                        </div>
                        <?php endif; ?>
